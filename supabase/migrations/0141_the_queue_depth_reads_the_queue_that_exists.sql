-- =====================================================================
-- 0141_the_queue_depth_reads_the_queue_that_exists.sql
--
-- ## The defect
--
...
comment on function public.platform_queue_depths() is
  'Depth of the notification outbox by event, counted in the database. Replaces the console read of background_jobs, which has had no writer since Inngest was retired in 0087 and reported an empty queue forever. Operational platform roles only (0141).';
