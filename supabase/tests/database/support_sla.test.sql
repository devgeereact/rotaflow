...
-- A real grant, not just the boolean. `platform_admins_sync` sets
-- `profiles.is_platform_admin` from this row and `grant_platform_role` is the
...
-- all four platform roles. `0138` made it `is_platform_operational()`, and this
