...
| What the last design review found        | `docs/design-review/2026-09-10-full-ux-pass.md` — the whole product on 9–11 Sep 2026, driven at three viewport widths as owner, manager, staff and platform owner. Seventeen defects closed (BUG-088 to BUG-105, less BUG-104, which the verification pass had already fixed as GAP-118), none left open. The rota grid's own earlier review is `docs/design-review/2026-09-06-rota-builder.md`. Both are dated snapshots, not current state |
