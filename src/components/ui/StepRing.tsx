...
// Fixed decorative sweep for the 'active' state (docs/design/appboot.png measures
 ...
 * (docs/design/appboot.png): an icon inside a ring whose state reads at a glance,
