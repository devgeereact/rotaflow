  ...
  return (
    <Card className="px-6 py-4">
      <div className="mb-3 flex items-center justify-between gap-3">
        ...
        <div className="relative flex h-11 items-center rounded-lg border border-surface-border px-3 focus-within:ring-2 focus-within:ring-primary dark:border-surface-border-dark">
          <select
            value={range}
