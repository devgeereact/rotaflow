  ...
  return (
    <Card className="flex h-full flex-col rounded-xl p-6">
      ...
      <button
        ...
        className="mt-auto inline-flex min-h-11 items-center self-center rounded pt-5 text-sm font-semibold text-primary-ink dark:text-primary-ink-dark focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
      >
