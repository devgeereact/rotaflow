      ...
      <div className="mb-3 flex items-center justify-between gap-2">
        ...
        {onEdit && (
          <button
            type="button"
            onClick={onEdit}
            className="rounded text-[0.78rem] font-semibold text-primary-ink hover:underline dark:text-primary-ink-dark focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
          >
            Edit
          </button>
        )}
