...
/** Column widths as a share of the table, measured off design/Locations-Management.png. */
const COLUMNS: SiteColumn[] = [
  { key: 'location', label: 'Location', width: 'w-[26%]', sortable: true },
  { key: 'type', label: 'Type', width: 'w-[11%]' },
  { key: 'region', label: 'Region', width: 'w-[10%]' },
  { key: 'staff', label: 'Staff', width: 'w-[8%]', align: 'center' },
  { key: 'shifts', label: 'Upcoming Shifts', width: 'w-[12%]', align: 'center' },
  { key: 'coverage', label: 'Coverage', width: 'w-[11%]' },
...
/** The sites table on design/Locations-Management.png. */
          ...
          >
            <td className={cn(CELL, 'pl-4')}>
              <div className="flex items-center gap-3">
                <LocationThumb name={row.name} photoUrl={row.photoUrl} />
