...
export function QuickActionsCard({ actions }: QuickActionsCardProps): JSX.Element {
  return (
    <Card className="p-3.5">
      <h2 className="mb-2.5 text-[0.9rem] font-semibold text-content dark:text-content-dark">
        Quick Actions
      </h2>
