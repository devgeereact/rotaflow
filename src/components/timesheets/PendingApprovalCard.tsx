            ...
            <li key={item.id}>
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <p className="truncate text-[0.7rem] font-semibold leading-[1.15rem] text-content dark:text-content-dark">
                    {item.firstName} {item.lastName}
                  </p>
                  <p className="truncate text-[0.66rem] leading-4 text-content-muted dark:text-content-muted-dark">
                    {item.submittedLabel}
                  </p>
                </div>
                <span className="shrink-0 self-start text-[0.66rem] tabular-nums text-content-muted dark:text-content-muted-dark">
                  {item.hoursLabel}
                </span>
              </button>
            </li>
